...
object FakeNewsApi : NewsApi {
    ...
    override suspend fun getNews(
        ...
        return NewsResponseDto(
            ...
            newsList = listOf(
                NewsItemDto(
                    id = "1", ctime = "2 小时前", title = "Android 15 正式发布",
                    description = "Google 推出 Android 15,新增预测性返回手势与照片权限。",
                    source = "新华社", picUrl = null, url = null
                ),
                NewsItemDto(
                    id = "2", ctime = "5 小时前", title = "Kotlin 2.0 稳定版发布",
                    description = "K2 编译器带来大幅编译性能提升。",
                    source = "InfoQ", picUrl = null, url = null
                ),
                NewsItemDto(
                    id = "3", ctime = "1 天前", title = "Jetpack Compose 里程碑",
                    description = "Compose 现已支持全部主流 View 组件。",
                    source = "掘金", picUrl = null, url = null
                )
            )
        )
    }
