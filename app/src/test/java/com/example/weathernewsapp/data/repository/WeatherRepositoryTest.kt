...
class WeatherRepositoryTest {
    ...
    private val sampleDto = WeatherResponseDto(
        latitude = 39.9042,
        longitude = 116.4074,
        timezone = "Asia/Shanghai",
        elevation = 0.0,
        currentUnits = CurrentUnitsDto(
    ...
    private val cachedEntity = WeatherEntity(
        cityName = "北京",
        temperature = "26.0°C",
    ...
    @Test
    fun `success writes to Room`() = runTest {
    ...
    @Test
    fun `getDefaultWeather reads DataStore default city`() = runTest {
    ...
    @Test
    fun `network fail with cache - returns Success isFromCache`() = runTest {
        // Given: 网络失败;Room 有缓存
    ...
    @Test
    fun `network fail with no cache - returns Error NoNetwork`() = runTest {
    ...
    @Test
    fun `http 5xx - returns Server error type`() = runTest {
